...
"""The graphical part of a Frequencies step"""
...
class TkFrequencies(seamm.TkNode):
    """
    ...
    self[widget] : dict
        ...
        contained in Frequencies_parameters.py

    See Also
    --------
    Frequencies, TkFrequencies,
    ...
    def create_dialog(self):
        ...
        based on what is specified in the Frequencies_parameters
        module.
        ...
        See Also
        --------
        TkFrequencies.reset_dialog
        """

        frame = super().create_dialog(title="Frequencies")
