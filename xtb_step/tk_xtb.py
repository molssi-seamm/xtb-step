...
class TkxTB(seamm.TkNode):
    ...
    self[widget] : dict
        ...
        contained in xTB_parameters.py
    ...
    def __init__(
        ...
        tk_flowchart=None,
        node=None,
        namespace="org.molssi.seamm.xtb.tk",
        canvas=None,
        x=None,
        y=None,
        w=200,
    ...
    def create_dialog(self):
        ...
        based on what is specified in the xTB_parameters
        module.
        ...
        frame = super().create_dialog(title="xTB")
        # make it large!
