...
class FrequenciesStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the Frequencies step. It must be
    ...
    my_description = {
        "description": "An interface for Frequencies",
        "group": "Calculations",
        "name": "Frequencies",
    }
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return xtb_step.Frequencies(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return xtb_step.TkFrequencies(canvas=canvas, **kwargs)
